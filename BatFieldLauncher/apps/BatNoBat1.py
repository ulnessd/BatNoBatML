...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        try:
            ...
            png_path = (Path(__file__).resolve().parent / "batcrossingguard.png")
            if png_path.exists():
        ...
        # Build a robust path to the model, assuming it's in the same folder as the script
        model_default_path = Path(__file__).parent / "BatNoBat_Beta.keras"
